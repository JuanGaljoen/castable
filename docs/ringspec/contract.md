...
| `multi_feature_unvalidated` | More than one of `{halo, trilogy, side_stone}` present. CP1 placeholder (RNG-24 specs/RNG-24.md CP2 replaces this with real cross-feature checks); `field` names the features involved, joined with `+`. |
